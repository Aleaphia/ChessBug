...
public class ClientAuthException extends Exception {
	...
	private String type;
	private NetworkException response;

	public ClientAuthException(String type, NetworkException response) {
		this.response = response;
		this.type = type;
	}

	public NetworkException getServerResponse() { return response; }
